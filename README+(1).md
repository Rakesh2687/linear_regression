...
Demand of bikes depend on year, holiday,working day, temp, windspeed, sep,mon, Light_snowrain, Misty, spring, summer and winter.
...
library - pandas library -numpy library - sklearn Using Python programming in Jupyter notebook following steps has been adopted
...
## Acknowledgements
Thanks to the upgrad support team ,industry PI and IIIT Professors and SMES

## Contact
Created by Rakesh Chandrashekar
